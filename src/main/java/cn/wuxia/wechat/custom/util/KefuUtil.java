...
public class KefuUtil extends BaseUtil {
     ...
     */
    public static List<KefuAccount> getAllKefu(BasicAccount account) throws WeChatException {
     ...
     * @throws WeChatException
     */
    public static boolean createSession(BasicAccount account, KefuAccount kfAccount, String openid) throws WeChatException {
     ...
     * @throws WeChatException
     */
    public static boolean closeSession(BasicAccount account, KefuAccount kfAccount, String openid) throws WeChatException {
     ...
     * @throws WeChatException
     */
    public static KefuSession getSession(BasicAccount account, String openid) throws WeChatException {
    ...
    public static KefuSession getSession(BasicAccount account, KefuAccount kefuAccount) throws WeChatException {
