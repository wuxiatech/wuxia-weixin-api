...
public class QrcodeUtil extends BaseUtil {
    ...
    private final static String showqrcodeUrl = "https://mp.weixin.qq.com/cgi-bin/showqrcode";
    ...
    public static File showqrcode(String ticket, String scentId, String waterPath) throws Exception {
        ...
        if (StringUtil.isNotBlank(waterPath)) {
            ...
            if (StringUtil.startsWith(waterPath, "http")) {
                String warterFilePath = System.getProperty("java.io.tmpdir") + File.separator + StringUtil.random(5) + scentId + ".jpg";
                warterFile = HttpClientUtil.download(waterPath, warterFilePath);
            } else {
     ...
     * @throws WeChatException 
     */
    public static Map<String, Object> createLimit(BasicAccount account, int sceneId) throws WeChatException {
        Assert.isTrue(sceneId >= 1 && sceneId <= 100000, "sceneId 必须为1-100000的数字");
        Map<String, Object> map = new HashMap<String, Object>();
