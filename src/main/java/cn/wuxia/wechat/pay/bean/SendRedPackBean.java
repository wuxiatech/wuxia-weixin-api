...
public class SendRedPackBean {
    ...
    String scene_id;//	否	PRODUCT_8	String(32)
    ...
    String risk_info;//	否	posttime%3d123123412%26clientversion%3d234134%26mobile%3d122344545%26deviceid%3dIOS	String(128)
    //    posttime:用户操作的时间戳
    //
    ...
    String consume_mch_id; // 否	1222000096	String(32)
    //    资金授权商户号
    //
    //            服务商替特约商户发放时使用
