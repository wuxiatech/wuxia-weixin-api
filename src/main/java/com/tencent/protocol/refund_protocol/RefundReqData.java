 ...
 * Time: 16:12
 */
public class RefundReqData extends TokenUtil {
     ...
     */
    public RefundReqData(PayAccount account, String transactionID, String outTradeNo, String deviceInfo, String outRefundNo, int totalFee,
            int refundFee, String opUserID, String refundFeeType) {

        //微信分配的公众号ID（开通公众号之后可以获取到）
        setAppid(properties.getProperty("APP_ID"));

        //微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
        setMch_id(properties.getProperty("PARTNER"));
        ...
        //根据API给的签名规则进行签名
        String sign = PaySignUtil.createSign(account, toSortedMap());
        setSign(sign);
